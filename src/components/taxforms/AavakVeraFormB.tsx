  ...
  return (
    <div className="tax-form-container tax-form-print page-break aavak-vera-form" id="aavak-vera-form-b">
      ...
      <table className="w-full border-collapse" style={{ fontSize: '7pt' }}>
        <tbody>
          <tr>
            <td colSpan={8} className="text-center font-bold border border-black py-1" style={{ fontSize: '11pt' }}>
      ...
      <table className="w-full border-collapse mt-1" style={{ fontSize: '6.5pt' }}>
        <tbody>
          <tr>
      ...
      {/* Tax Slabs Table */}
      <table className="w-full border-collapse mt-1" style={{ fontSize: '6pt' }}>
        <tbody>
          <tr>
            <td className="border border-black px-1 py-0.5">1</td>
      ...
      {/* Footer */}
      <div className="form-footer text-center mt-1 pt-1" style={{ fontSize: '6pt' }}>
