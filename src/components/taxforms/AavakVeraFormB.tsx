  ...
  return (
    <div className="tax-form-container tax-form-print page-break aavak-vera-form" id="aavak-vera-form-b">
      ...
      <table className="w-full border-collapse" style={{ fontSize: '9pt' }}>
        <tbody>
          <tr>
            <td colSpan={8} className="text-center font-bold border border-black py-1" style={{ fontSize: '12pt' }}>
      ...
      <table className="w-full border-collapse mt-2" style={{ fontSize: '8pt' }}>
        <tbody>
          <tr>
