...
const AavakVeraFormB = ({ client, formData, onChange, readOnly = false, isManualMode = false }: AavakVeraFormBProps) => {
  ...
  return (
    <div className="tax-form-container tax-form-print page-break aavak-vera-form" id="aavak-vera-form-b">
      ...
      <table className="w-full border-collapse mt-0.5" style={{ fontSize: '5.5pt' }}>
        <tbody>
          <tr>
      ...
      {/* Tax Slabs Table */}
      <table className="w-full border-collapse mt-0.5" style={{ fontSize: '5pt' }}>
        <tbody>
          <tr>
            <td className="border border-black px-1 py-0.5">1</td>
      ...
      {/* Footer */}
      <div className="form-footer text-center mt-0.5 pt-0.5" style={{ fontSize: '5pt' }}>
